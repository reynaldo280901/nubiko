                    ...
                    <div class="app-page-title">
                        ...
                        <div class="container">
                            <div class="container-menu-tracking">
                                <h1>TANGGAL PAKET OUTBOUND KELUAR</h1>
                            </div>
                            <div class="btn-scan">
                                <form action="{{ route('cek-expedisi') }}" method="post">
                                    @csrf
                                    ...
                                    <input type="text" name="datefilter" value="DD/MM/YYYY" />
                                    ...
                                    <div class="mulai-scan">
                                    <button type="submit" class="btn-mulai-scan">Mulai Scan</button>
                                    </div>
                                </form>
