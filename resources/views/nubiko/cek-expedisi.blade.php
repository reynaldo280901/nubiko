...
<head>
    ...
    <style>
        ...
        *::after {
        ...
        .pilihan-expedisi .jne,
        .pilihan-expedisi .jnt,
        .pilihan-expedisi .sicepat,
        .pilihan-expedisi .shopee-express {
            text-align: center;
            padding: 20px;
            box-sizing: border-box;
        }

        .pilihan-expedisi .jne img,
        .pilihan-expedisi .jnt img,
        .pilihan-expedisi .sicepat img,
        .pilihan-expedisi .shopee-express img {
            width: 120px;
            height: 100px;
        }
        ...
        .pilihan-expedisi .jne .btn-mulai-scan {
            background-color: white;
            color: black;
        }

        .pilihan-expedisi .jnt .btn-mulai-scan {
            background-color: white;
            color: black;
        }

        .pilihan-expedisi .sicepat .btn-mulai-scan {
            background-color: white;
            color: black;
        }

        .pilihan-expedisi .shopee-express .btn-mulai-scan {
            background-color: white;
            color: black;
        }
            ...
            <div class="app-main__outer">
                <div class="app-main__inner">
                    <div class="app-page-title">
                        ...
                        <form action="{{ route('marketplace', ['datefilter' => $datefilter]) }}" method="get">
                            @csrf
                            <input type="hidden" name="datefilter" value="{{ $datefilter }}">

                            <div class="container">
                                <div class="container-menu-tracking">
                                    <h1>Id_Ekspedisi Scan</h1>
                                    <div class="input-id-expedisi">
                                        <input type="text" name="expedisi" />
                                    </div>
                                </div>
                                <div class="pilihan-expedisi">
                                @foreach($expedisiOptions as $expedisiOption)
                                    <div class="{{ strtolower($expedisiOption) }}">
                                    <img src='img/expedisi/{{ strtolower($expedisiOption) }}.png'>
                                    <button type="submit" name="expedisi" value="{{ $expedisiOption }}" class="btn-mulai-scan">Mulai</button>
                                    @endforeach    
                                </div>
