...
<head>
    ...
    <style>
        ...
        *::after {
        ...
        .pilihan-expedisi .logo-shopee,
        .pilihan-expedisi .logo-tokped,
        .pilihan-expedisi .logo-blibli,
        .pilihan-expedisi .logo-guyub,
        .pilihan-expedisi .logo-lazada,
        .pilihan-expedisi .logo-tiktokshop,
        .pilihan-expedisi .logo-orderonline {
            text-align: center;
            padding: 20px;
            box-sizing: border-box;
        }

        .pilihan-expedisi .logo-shopee img,
        .pilihan-expedisi .logo-tokped img,
        .pilihan-expedisi .logo-blibli img,
        .pilihan-expedisi .logo-guyub img,
        .pilihan-expedisi .logo-lazada img,
        .pilihan-expedisi .logo-tiktokshop img,
        .pilihan-expedisi .logo-orderonline img {
            width: 80px;
            height: 80px;
        }

        .pilihan-expedisi .btn-mulai-scan {
            margin-left: 10%;
            width: 35%;
            box-sizing: border-box;
            text-align: center;
        ...
        .pilihan-expedisi .logo-shopee .btn-mulai-scan {
            background-color: white;
            color: black;
        }

        .pilihan-expedisi .logo-tokped .btn-mulai-scan {
            background-color: white;
            color: black;
        }

        .pilihan-expedisi .logo-blibli .btn-mulai-scan {
            background-color: white;
            color: black;
        }

        .pilihan-expedisi .logo-orderonline .btn-mulai-scan {
            background-color: white;
            color: black;
        }
                    ...
                    <div class="app-page-title">
                        ...
                        <div class="container">
                            <div class="container-menu-tracking">
                                <h1>Id_MarketPlace</h1>
                                <div class="input-id-expedisi">
                                    <input type="text" name="marketplace" />
                                </div>
                            </div>
                            <div class="pilihan-expedisi">
                                <form
                                    action="{{ route('data_nubiko', ['expedisi' => request('expedisi'), 'datefilter' => request('datefilter')]) }}"
                                    method="get">
                                    @csrf
                                    ...
                                    <div class="logo-shopee">
                                        <img src="{{ asset('img/marketplace/shopee.png') }}">
                                        <button type="submit" name="marketplace" value="spx"
                                            class="btn-mulai-scan">Mulai</button>
                                    </div>
                                    <div class="logo-blibli">
                                        <img src="{{ asset('img/marketplace/blibli.png') }}">
                                        <button type="submit" name="marketplace" value="blibli"
                                            class="btn-mulai-scan">Mulai</button>
                                    </div>
                                    <div class="logo-tokped">
                                        <img src="{{ asset('img/marketplace/tokped.png') }}">
                                        <button type="submit" name="marketplace" value="tokpededia"
                                            class="btn-mulai-scan">Mulai</button>
                                    </div>
                                    <div class="logo-orderonline">
                                        <img src="{{ asset('img/marketplace/orderonline.png') }}">
                                        <button type="submit" name="marketplace" value="orderonline"
                                            class="btn-mulai-scan">Mulai</button>
                                    </div>
                                    <div class="logo-tiktokshop">
                                        <img src="{{ asset('img/marketplace/tiktokshop.png') }}">
                                        <button type="submit" name="marketplace" value="tiktokshop"
                                            class="btn-mulai-scan">Mulai</button>
                                    </div>
                                    <div class="logo-guyub">
                                        <img src="{{ asset('img/marketplace/guyub.png') }}">
                                        <button type="submit" name="marketplace" value="guyub"
                                            class="btn-mulai-scan">Mulai</button>
                                    </div>
                                    <div class="logo-lazada">
                                        <img src="{{ asset('img/marketplace/lazada.png') }}">
                                        <button type="submit" name="marketplace" value="lazada"
                                            class="btn-mulai-scan">Mulai</button>
                                    </div>
                                </form>
                            </div>
