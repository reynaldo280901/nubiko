                    ...
                    <div class="app-page-title">
                        ...
                        <div class="container">
                            ...
                            <div class="table-responsive text-center">
                                <form
                                    action="{{ route('scan.start', ['marketplace' => request('marketplace'),'expedisi' => request('expedisi'), 'datefilter' => request('datefilter')]) }}"
                                    method="get">
                                    @csrf
                                    ...
                                    <table class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="checkbox" name="id_produk[]"
                                                        value="{{ $data->id_produk }}">
                                                        <input type="hidden" name="nama_produk[]"
                                                        value="{{ $data->nama_produk }} "></td>
                                            </tr>
                                            @endforeach
                                            @else
                                    ...
                                    <button type="submit" class="btn btn-primary">Mulai Scan</button>
                                </form>
                            </div>
